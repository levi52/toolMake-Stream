...
"}")
        self.logo.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("asserts/icon/Tool.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.horizontalLayout.addWidget(self.header_left_frame, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("asserts/icon/Minimize.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("asserts/icon/window-maximize.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("asserts/icon/close.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("asserts/icon/audio.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("asserts/icon/video.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("asserts/icon/chat.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.horizontalLayout_8.addWidget(self.menu_frame, 0, QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.verticalLayout_5.addWidget(self.label_6, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
...
"}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("asserts/icon/audios.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.horizontalLayout_10.addWidget(self.audio_input, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("asserts/icon/play.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.horizontalLayout_10.addWidget(self.audio_output, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.verticalLayout_5.addWidget(self.audio_recorder, 0, QtCore.Qt.AlignmentFlag.AlignVCenter)
...
"}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("asserts/icon/camera.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("asserts/icon/pause.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("asserts/icon/stop circle.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.char_frame = QtWidgets.QFrame(self.chat)
        self.char_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.char_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.char_frame.setObjectName("char_frame")
        self.label_8 = QtWidgets.QLabel(self.char_frame)
        self.label_8.setGeometry(QtCore.QRect(40, 10, 51, 21))
        font = QtGui.QFont()
        font.setFamily("SansSerif")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.verticalLayout_4.addWidget(self.char_frame)
        ...
        self.horizontalLayout_6.addWidget(self.copyright, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        self.horizontalLayout_4.addWidget(self.footer_right_frame, 0, QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        self.horizontalLayout_4.addWidget(self.size_grip, 0, QtCore.Qt.AlignmentFlag.AlignBottom)
    ...
    def open_camera(self):
        ...
        if not self.isCamera:
            self.fileName, self.fileType = QFileDialog.getOpenFileName(self, 'Choose file', '', "MP4Files(*.mp4);;AVI Files(*.avi)")
            ...
            while exists:
                if os.path.exists(f"./media/video{self.video_index}.avi"):
                    ...
                    exists = False
            self.video_output = cv2.VideoWriter(f'./media/video{self.video_index}.avi',self.fourcc, 30.0, (640,480))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.audio_name.setText(_translate("MainWindow", "Audio"))
        self.video_label.setText(_translate("MainWindow", "Video"))
        self.label_8.setText(_translate("MainWindow", "chat"))
