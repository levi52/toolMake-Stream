...
"}")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("asserts/icon/connect.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.file_con_btn.setIcon(icon14)
        ...
        self.pushButton = QtWidgets.QPushButton(self.choose_frame)
...
"}")
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("asserts/icon/s_connect.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("asserts/icon/call.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.start_chat_btn.setIcon(icon16)
...
"}")
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("asserts/icon/stop-call.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stop_chat_btn.setIcon(icon17)
...
"}")
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap("asserts/icon/submit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.submit_btn.setIcon(icon18)
        ...
        self.ip_lineEdit.setText("192.168.1.100")
    ...
    def open_file(self):
        # 打开文件
        filePath, oth = QFileDialog.getOpenFileName(self, "Open File")
        print(filePath)
        if filePath:
