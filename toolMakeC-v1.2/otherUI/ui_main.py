...
"}")
    ...
    def send_frame(self, sock):
            ...
            self.cap.release()
            self.stopChatEvent.clear()    # 接收视频帧
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "tool Make Client"))
        self.title.setText(_translate("MainWindow", "tool Make Client"))
